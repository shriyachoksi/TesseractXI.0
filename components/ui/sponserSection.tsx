  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-tesseract-light/60 via-tesseract-cream/40 to-tesseract-sand/60 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2
            className="text-4xl md:text-4xl font-bold text-tesseract-dark mb-4"
            style={{
          ...
          >
            Supported by industry leaders who believe in the future of
            technology
          </p>
        </motion.div>
                  ...
                  >
                    <div className="flex items-center justify-center h-16 mb-4">
                      <motion.img
                        src={
                          sponsorLogos[
                            Math.floor(Math.random() * sponsorLogos.length)
                          ]
                        }
                        alt={sponsor}
        ...
        >
          <div className="bg-tesseract-light/80 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto shadow-2xl border border-tesseract-sand/30">
            ...
            >
              Join us in shaping the future of technology. Partner with
              Tesseract 2025 and showcase your innovation to the next
              generation.
            </p>
            <motion.button
