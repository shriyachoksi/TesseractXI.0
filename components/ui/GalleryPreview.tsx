...
import { getAllImages45, GalleryImage } from "@/app/gallery/data";
export default function GalleryPreview() {
  ...
  return (
    <section
      className="py-20 px-8 bg-gradient-to-b from-tesseract-light to-tesseract-cream"
